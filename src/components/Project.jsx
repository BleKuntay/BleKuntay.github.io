...
const Project = ({ picture, projectName = "Project Name", projectDetails, projectUrl }) => {
    ...
    return (
        <div className='card text-white bg-secondary p-3 w-[90%] sm:w-[80%] md:w-[60%] xl:w-[18%] rounded-lg flex flex-col items-center justify-end'>
            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
                    <div className="bg-white shadow-2xl text-black p-6 rounded-lg xl:w-1/4 w-[90%]">
                        <img src={picture} alt="" className='w-full mb-2'/>
                        <h2 className="font-semibold text-xl mb-2">{projectName}</h2>
                        <p>{projectDetails}</p>
